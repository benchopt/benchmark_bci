...
class FBCNetNoFilterLayer(EEGModuleMixin, nn.Module):
    """FBCNet from Maine, R et al (2021) [fbcnet2021]_.
    ...
    References
    ----------
    .. [fbcnet2021] Maine, R., Chew, E., Chua, K., Ang, K. K., Robinson, N.,
    ...
    def __init__(
        ...
        self.spatial_conv = nn.Sequential(
            Conv2dWithConstraint(
                ...
                kernel_size=(self.n_chans//self.n_bands, 1),
                groups=self.n_bands,
                max_norm=2,
                padding=0,
            ),
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        """
        x = x.view(x.shape[0], 22, self.n_bands, self.n_times)
